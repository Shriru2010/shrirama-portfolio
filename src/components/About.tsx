  ...
  return <section id="about" className="py-20 relative">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 scroll-reveal">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">I'm a <span className="text-primary font-bold">कट्टर सनातनी</span> and proud <span className="text-accent font-bold">ब्राह्मण</span> 🚩, dedicated student with a passion for yoga, and most of all, coding. As a Veda practitioner learning Yajurveda and Rigveda, I focus on Sanskrit computation, full-stack web development, and Java. I'm also skilled in video editing, photo editing, and ethical hacking. My spiritual inspiration comes from Lord Shiva, Hanuman, and my hero—Chhatrapati Shivaji Maharaj.</p>
        </div>
