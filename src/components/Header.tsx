  ...
  return (
    <>
      ...
      <Button
        ...
        className="fixed top-4 left-4 z-[110] p-3 magnetic-button morphing-icon holo-border hover:shadow-glow-strong transition-all duration-300 bg-background/80 backdrop-blur-sm"
      >
        <Menu className="h-5 w-5 text-primary" />
      </Button>

      <header className={`fixed top-0 left-0 right-0 z-100 transition-all duration-500 transform ${
        isHeaderVisible 
